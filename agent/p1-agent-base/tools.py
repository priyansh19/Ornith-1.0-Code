...
# Deliberately minimal — this harness's identity is "the plain single ReAct
# loop baseline," no scout dispatch, no persistent memory, no multi-agent
# routing. Kept genuinely simple, not a relabeled clone of a richer harness.
TOOLS = {
