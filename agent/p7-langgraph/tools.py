...
# Consume-once, same pattern as the dict-style harnesses (p4-agent-to-agent):
# write_file sets this right after writing; the harness loop reads (and
# clears) it immediately after the ToolMessage for write_file comes back.
...
LC_TOOLS = [calculator, read_file, write_file, list_files, shell, remember, recall, list_memories, forget]
